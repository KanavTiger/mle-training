...
def create_training_datasets(context, params):
    ...
    with mlflow.start_run(run_name="create_training_datasets"):

        # Log parameters
        mlflow.log_params(params)

        # Log the input dataset
        #mlflow.log_artifact(input_dataset, "input_data")

        # Log the output datasets as artifacts
        #mlflow.log_artifact(output_train_features, "train_features")
        #mlflow.log_artifact(output_train_target, "train_target")
        #mlflow.log_artifact(output_test_features, "test_features")
        #mlflow.log_artifact(output_test_target, "test_target")
